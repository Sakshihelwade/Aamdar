...
const DubarTable2 = ({ Props, onPageChange, voterCount }) => {
        ...
        <table className="w-full bg-white border border-gray-200">
          <thead>
            <tr className="bg-gray-300 text-gray-600 text-sm leading-normal">
              {/* Table Headers */}
              <th className="px-1 h-[55px] border border-gray-300">भाग/बूथ नं</th>
              <th className="px-1 h-[55px] border border-gray-300">अ.नं.</th>
              <th className="px-1 h-[55px] border border-gray-300">नाव</th>
              <th className="px-1 h-[55px] border border-gray-300">वय </th>
              <th className="px-1 h-[55px] border border-gray-300">लिंग </th>
              <th className="px-1 h-[55px] border border-gray-300">मोबाईल नं</th>
              <th className="px-1 h-[55px] border border-gray-300">नवीन पत्ता</th>
              <th className="px-1 h-[55px] border border-gray-300">घर नं</th>
              <th className="px-1 h-[55px] border border-gray-300">पत्ता</th>
              <th className="px-1 h-[55px] border border-gray-300">कार्ड नं</th>
              <th className="px-1 h-[55px] border border-gray-300">मुळगाव</th>
              <th className="px-1 h-[55px] border border-gray-300">क्रिया</th>
            </tr>
          </thead>
