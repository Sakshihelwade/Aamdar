...
const Landmark = ({ title = "जवळचे ठिकाण" }) => {
    ...
    const addCast = async () => {
        ...
        console.log(payload)
        try {
            const resp = await axios.post(`${base_url}/insert-landmark`, payload)
    ...
    const editCast = async () => {
        ...
        try {
            const resp = await axios.post(`${base_url}/updateLandmark/${castId}`, payload)
            console.log(resp.data)
    ...
    const deleteCast = async () => {
        try {
            await axios.post(`${base_url}/deleteLandmark/${castId}`);
