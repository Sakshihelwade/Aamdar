...
const id=localStorage.getItem('_id')
  ...
  const getAllVoters = () => {
    axios
      .get(`${base_url}/api/surve/searchVotter/${id}?alphabet=true&boothNo=${boothNo}&village=${villageName}&page=${currentPage}&minBooth=${fromList}&maxBooth=${toList}&gath=${gathName}&gathaId=${gathId}&gan=${ganName}&ganId=${ganId}`)
      .then((resp) => {
