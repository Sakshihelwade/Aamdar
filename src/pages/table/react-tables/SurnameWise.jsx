...
const SurnameWise = () => {
  ...
  const getAllVoters = () => {
    axios
      .get(`${base_url}/api/surve/searchVotter/${id}?lastName=true&boothNo=${boothNo}&village=${villageName}&page=${currentPage}&minBooth=${fromList}&maxBooth=${toList}&lastNameFilter=${Surname}&gath=${gathName}&gathaId=${gathId}&gan=${ganName}&ganId=${ganId}`)
      .then((resp) => {
  ...
  const getSurnameWiseVoter = () => {
    axios.get(`${base_url}/api/surve/searchVotter/${id}?name=true&CountLastNames=true&village=${villageName}&gathaId=${gathId}&ganId=${ganId}`)
      .then((resp) => {
  ...
  useEffect(() => {
    ...
    getAllVoters()
  }, [currentPage, selectedSurname, villageName, boothNo, fromList, toList, surname, Surname,gathName,ganName])
